...
import { GET_WALLETS_PENDING, GET_WALLETS_SUCCESS, GET_WALLETS_FAILURE, ADD_WALLET_PENDING, ADD_WALLET_SUCCESS, ADD_WALLET_ERROR, DELETE_WALLET, ADD_INCOME, ADD_EXPENSE, ADD_TRANSACTION, SET_EXPENSE_TRANSACTION, SET_AMOUNT_TRANSACTION, SET_TIME_TRANSACTION, SET_CATEGORY_TRANSACTION, SET_ACTIVE_WALLET, TOGGLE_CREATING } from "./types";
...
export const toggleCreating = () => ({
  type: inferStringLiteral(TOGGLE_CREATING),
  payload: null,
});
